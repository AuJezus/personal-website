function SkillCard({ children, icon, name }) {
  return (
    <div className="group grid w-full grid-cols-3 grid-rows-[auto,_auto,_1fr] divide-x divide-y divide-violet-500 border border-violet-500 transition-all hover:scale-105 hover:shadow-lg hover:shadow-violet-500">
