...
function UserSettings() {
  ...
  return (
    <form className="p-2 max-w-6xl mx-auto">
      <div className="flex items-start w-full justify-around gap-8 flex-wrap">
        ...
        <div className="flex flex-col gap-6">
          <span className="text-3xl font-bold block">Contact settings</span>
